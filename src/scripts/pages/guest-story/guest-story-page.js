...
export default class GuestStoryPage {
  ...
  constructor() {
    this.#presenter = new GuestStoryPresenter(this);
  }

  async render() {
    return `
          <section class="container">
            <h1 class="page-title">Kirim Cerita sebagai Tamu</h1>
             <div class="add-story-container">
                <form id="guest-story-form">
  ...
  _initForm() {
    const guestStoryForm = document.getElementById("guest-story-form");
    guestStoryForm.addEventListener("submit", async (event) => {
